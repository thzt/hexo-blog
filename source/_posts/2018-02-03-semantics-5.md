...
指定<span data-katex="0:nat"></span>，<span data-katex="1:nat"></span>，<span data-katex="+:nat\times nat"></span>，<span data-katex="\cdot:nat\times nat"></span>，
...
<span data-katex="F"></span>是函数符号的集合<span data-katex="\{0:nat,1:nat,+:nat\times nat,\cdot:nat\times nat\}"></span>。
...
其中，<span data-katex="S=\{nat\}"></span>，<span data-katex="F=\{0:nat,1:nat,+:nat\times nat,\cdot:nat\times nat\}"></span>。
