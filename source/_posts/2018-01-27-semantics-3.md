...
初等算术语言是一个一阶语言，记为<span data-katex="\mathscr{A}"></span>。
...
初等算术语言<span data-katex="\mathscr{A}"></span>中的合法项，
...
例，我们可以指定初等算术语言<span data-katex="\mathscr{A}"></span>的结构为，偶对<span data-katex="N=(\mathbb{N}, I)"></span>，
...
例，初等算术<span data-katex="\mathscr{A}"></span>中项的语义，
