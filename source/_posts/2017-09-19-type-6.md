...
只包含一个类型构造器（type constructor）<span data-katex="\to"></span>，

接受两个类型<span data-katex="T_1,T_2"></span>作为参数，返回一个函数类型<span data-katex="T_1\to T_2"></span>。
...
（3）<span data-katex="\frac{\Gamma\vdash t_1:T_1\to T_2~~~~\Gamma\vdash t_2:T_2}{\Gamma\vdash t_1~t_2:T_2}"></span>
